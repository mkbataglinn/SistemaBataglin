 ...
 * @author 07788816108
 */
public class McbComprasProduto {

    public int getMcbIdComprasProdutos() {
        return mcbIdComprasProdutos;
    }

    public void setMcbIdComprasProdutos(int mcbIdComprasProdutos) {
        this.mcbIdComprasProdutos = mcbIdComprasProdutos;
    }
    ...
    private int mcbIdComprasProdutos;
